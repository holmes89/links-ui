...
* [`src/cljs/links_ui/`](src/cljs/links_ui/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/links_ui/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `links-ui` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/links_ui/config.cljs) defaults to `true` in
...
```clj
(ns links-ui.example
  (:require [links-ui.config :as config])
